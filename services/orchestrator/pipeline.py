...
Environment:
    ...
    RP_ORCHESTRATOR_EXTRACTOR_TIMEOUT=15000  # Extractor-specific timeout (seconds)
...
class PipelineRunner:
    ...
    STAGE_TIMEOUTS: dict[str, int] = {
        ...
        "extractor": int(os.environ.get("RP_ORCHESTRATOR_EXTRACTOR_TIMEOUT", "15000")),
    ...
    def __init__(self, db_path: str | Path) -> None:
        ...
        self.external_health_timeout = float(
            os.environ.get("RP_ORCHESTRATOR_EXTERNAL_HEALTH_TIMEOUT", "5")
        )
        ...
        self.STAGE_TIMEOUTS = {
            ...
            "extractor": int(
                os.environ.get("RP_ORCHESTRATOR_EXTRACTOR_TIMEOUT", "15000")
            ),
            "codegen": int(
    ...
    def run(
        ...
        try:
            for stage_name, port in stage_list:
                ...
                try:
                    retry_on_timeout = stage_name not in {"analyzer", "extractor"}
    ...
    def check_external_health(self) -> dict:
        ...
        for name, base_url, health_path in EXTERNAL_DEPS:
            ...
            try:
                resp = requests.get(url, timeout=self.external_health_timeout)
